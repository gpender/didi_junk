...
{
    /// <summary>
    /// Interaction logic for ScopeNoViewModelUC.xaml
    /// </summary>
    public partial class ScopeNoViewModelUC : UserControl
    {
        ...
        private IXyDataSeries<TimeSpan, double> series0;
        private IXyDataSeries<TimeSpan, double> series1;
        private IXyDataSeries<TimeSpan, double> series2;

        private TimedMethod _startDelegate;

        public ScopeNoViewModelUC()
        {
            InitializeComponent();
        ...
        private void CreateDataSetAndSeries()
        {
            ...
            series0 = new XyDataSeries<TimeSpan, double>();
            series1 = new XyDataSeries<TimeSpan, double>();
        ...
        private void OnNewData(object sender, EventArgs e)
        {
            ...
            using (sciChart.SuspendUpdates())
            {
                ...
                series0.Append(TimeSpan.FromSeconds(t), y1);
                series1.Append(TimeSpan.FromSeconds(t), y2);
                series2.Append(TimeSpan.FromSeconds(t), y3);
            }
